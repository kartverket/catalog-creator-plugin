...
export const CatalogSearch = ({ value, onChange, filter, onBlur, label}: OwnerSearchProps) => {
        ...
        <div>
            ...
            <Paper style={{maxHeight: 300, overflow: 'auto', margin:'2px'}}>
                <List>
                    ...
                    >
                        <ListItemAvatar>
                            <Avatar src={owner?.spec.profile?.picture!} name={owner?.spec?.profile?.displayName!} />
                        </ListItemAvatar>
                        <ListItemText
